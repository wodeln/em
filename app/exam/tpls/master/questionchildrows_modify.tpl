					...
					<form action="index.php?exam-master-rowsquestions-modifychildquestion" method="post" class="form-horizontal">
						...
						<div class="form-group">
							<label class="control-label col-sm-2">题型：</label>
						  	<div class="col-sm-3">
							  	<select needle="needle" msg="您必须为要添加的试题选择一种题型" class="form-control" onchange="javascript:setAnswerHtml($(this).find('option:selected').attr('rel'),'answerbox');" disabled>
							...
							<input type="hidden" name="args[questiontype]" value="{x2;$question['questiontype']}">
						</div>
						<div class="form-group">
