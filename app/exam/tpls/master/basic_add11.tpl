				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?exam-master-basic-add" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" style="width: 70%">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-5">
                                        <select name="to[]" id="undo_redo_to" class="form-control" needle="needle" size="13" multiple="multiple" style="height:275px;"></select>
                                    </div>
                                </div>
                            </div>
                        </div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<button class="btn btn-prim name="page" value="{x2;$page}"/>
