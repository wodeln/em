...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?course-master-video-edit" method="post" class="form-horizontal">
							...
							<div class="col-sm-9">
								<script type="text/template" id="pe-template-course_files">
									<div class="qq-uploader-selector" qq-drop-area-text="可将图片拖拽至此处上传" style="clear:both;">
										...
										<ul class="qq-upload-list-selector list-unstyled pull-left" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
											<li class="text-center">
												<input size="45" class="form-control qq-edit-filename-selector" type="text" name="args[course_files]" tabindex="0" value="{x2;$video['course_files']}">
											</li>
										</ul>
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-10">
							    <textarea id="coursedescribe" name="args[coursedescribe]" class="form-control" rows="4">{x2;$video['coursedescribe']}</textarea>
					        </div>
				        </div>
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-9">
					            ...
					            <input type="hidden" name="courseid" value="{x2;$video['courseid']}">
