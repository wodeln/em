		...
		<div class="main box">
			...
			<div class="col-xs-4 pull-right" style="margin:30px 30px 0px auto;background-color:#FFFFFF;">
				<form class="col-xs-12" method="post" action="index.php?user-app-register">
					...
					<div class="form-group input-group">
						<span class="input-group-addon" id="basic-addon1"><a class="glyphicon glyphicon-option-horizontal" style="font-size:16px;"></a></span>
						<select id="modules" class="form-control combox" name="args[userclassid]" needle="needle" msg="您必须选择一个培训组">
							<option value="">请选择培训对象</option>
