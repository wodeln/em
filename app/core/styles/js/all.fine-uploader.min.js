...
!function (global) {
    ...
    !function () {
        ...
        function b() {
            var a = document.createElement("input");
            return a.setAttribute(qq.UploadButton.BUTTON_ID_ATTR_NAME, d), a.setAttribute("title", g.title), e.setMultiple(g.multiple, a), g.folders && qq.supportedFeatures.folderSelection && a.setAttribute("webkitdirectory", ""), g.acceptFiles && a.setAttribute("accept", g.acceptFiles), a.setAttribute("type", "file"), a.setAttribute("name", g.name), qq(a).css({
                position: "absolute",
                right: 0,
                top: 0,
                fontFamily: "Arial",
        ...
        qq.basePublicApi = {
            ...
            _addCannedFile: function (a) {
                ...
                var c, d = this, e = a.accept || this._options.validation.acceptFiles,
                ...
                if (this._options.camera.ios && qq.ios()) {
                    var a = "image/*;capture=camera", b = this._options.camera.button,
                        c = b ? this._getButtonId(b) : this._defaultButtonId, d = this._options;
                ...
                var d = this, e = qq.getUniqueId(), f = -1, g = qq.getFilename(a), h = a.blob || a,
                ...
                var e, f, g = this._options.messages[a], h = [], i = [].concat(b), j = i[0], k = this._getButtonId(c),
                ...
                b = this.getUploads({status: qq.status.SUBMITTING}).length, b && (qq.log("Still waiting for " + b + " files to clear submit queue. Will re-parse stored IDs array shortly."), setTimeout(function () {
                ...
                var c = this, d = function () {
                    ...
                    }(), e = b.name, f = b.size, g = this._getButtonId(a.file), h = this._getValidationBase(g),
                    i = new qq.Promise;
        ...
        function e() {
            var a;
            return (window.XMLHttpRequest || window.ActiveXObject) && (a = qq.createXhrInstance(), void 0 === a.withCredentials && (a = new XDomainRequest, a.onload = function () {
            }, a.onerror = function () {
        ...
        var c, d, e, f = this, g = !1, h = !1, i = {
            ...
            getIdsInBatch: function () {
                ...
                var b = i.getSize(a), c = i.getName(a), f = j.nextPart(a), g = e._getChunkData(a, f),
                    l = e._getFileState(a).attemptingResume, n = e._getFileState(a).chunking.inProgress || [];
                null == e._getFileState(a).loaded && (e._getFileState(a).loaded = 0), l && i.onResume(a, c, g) === !1 && (j.reset(a), f = j.nextPart(a), g = e._getChunkData(a, f), l = !1), null == f && 0 === n.length ? j.finalize(a) : (d(qq.format("Sending chunked upload request for item {}.{}, bytes {}-{} of {}.", a, f, g.start + 1, g.end, b)), i.onUploadChunk(a, c, e._getChunkDataForCallback(g)), n.push(f), e._getFileState(a).chunking.inProgress = n, h && k.open(a, f), h && k.available() && e._getFileState(a).chunking.remaining.length && j.sendNext(a), e.uploadChunk(a, f, l).then(function (b, c) {
                    d("Chunked upload request succeeded for " + a + ", chunk " + f), e.clearCachedChunk(a, f);
                    var g = e._getFileState(a).chunking.inProgress || [], h = m.normalizeResponse(b, !0),
                        i = qq.indexOf(g, f);
                    d(qq.format("Chunk {} for file {} uploaded successfully.", f, a)), j.done(a, f, h, c), i >= 0 && g.splice(i, 1), e._maybePersistChunkedState(a), j.hasMoreParts(a) || 0 !== g.length ? j.hasMoreParts(a) ? j.sendNext(a) : d(qq.format("File ID {} has no more chunks to send and these chunk indexes are still marked as in-progress: {}", a, JSON.stringify(g))) : j.finalize(a)
                }, function (b, g) {
                    d("Chunked upload request failed for " + a + ", chunk " + f), e.clearCachedChunk(a, f);
                    var l, n = m.normalizeResponse(b, !1);
                    n.reset ? j.reset(a) : (l = qq.indexOf(e._getFileState(a).chunking.inProgress, f), l >= 0 && (e._getFileState(a).chunking.inProgress.splice(l, 1), e._getFileState(a).chunking.remaining.unshift(f))), e._getFileState(a).temp.ignoreFailure || (h && (e._getFileState(a).temp.ignoreFailure = !0, d(qq.format("Going to attempt to abort these chunks: {}. These are currently in-progress: {}.", JSON.stringify(Object.keys(e._getXhrs(a))), JSON.stringify(e._getFileState(a).chunking.inProgress))), qq.each(e._getXhrs(a), function (b, c) {
                        d(qq.format("Attempting to abort file {}.{}. XHR readyState {}. ", a, b, c.readyState)), c.abort(), c._cancelled = !0
        ...
        var f = a.options, g = this, h = a.proxy, i = qq.getUniqueId(), j = {}, k = {}, l = {}, m = f.isCors,
            n = f.inputName, o = h.getUuid, p = h.log, q = new qq.WindowReceiveMessage({log: p});
        qq.extend(this, new qq.UploadHandler(a)), qq.override(this, function (a) {
            ...
            getInput: function (a) {
                ...
                var b = a.method, c = a.endpoint, d = a.params, e = a.paramsInBody, f = a.targetName,
                    g = qq.toElement("<form method='" + b + "' enctype='multipart/form-data'></form>"), h = c;
        ...
        var c = this, d = a.options.namespace, e = a.proxy, f = a.options.chunking, g = a.options.resume,
            h = f && a.options.chunking.enabled && qq.supportedFeatures.chunking,
            i = g && a.options.resume.enabled && h && qq.supportedFeatures.resume, j = e.getName, k = e.getSize,
            l = e.getUuid, m = e.getEndpoint, n = e.getDataByUuid, o = e.onUuidChanged, p = e.onProgress, q = e.log;
        qq.extend(this, new qq.UploadHandler(a)), qq.override(this, function (a) {
            return {
                add: function (b, d) {
            ...
            clearCachedChunk: function (a, b) {
                ...
                e && (q(qq.format("Moving these chunks from in-progress {}, to remaining.", JSON.stringify(e))), e.reverse(), qq.each(e, function (a, b) {
                    f.unshift(b)
                }), e.length = 0)
            }, pause: function (a) {
                ...
                var d = f.partSize, e = k(a), g = c.getFile(a), h = d * b, i = h + d >= e ? e : h + d,
                    j = c._getTotalChunks(a), l = this._getFileState(a).temp.cachedChunks,
                ...
                var e = c._getXhr(a, b), f = j(a), g = {
                    simple: function (b, c) {
                        ...
                        var h = c._getFileState(a).temp.chunkProgress, i = c._getFileState(a).loaded, j = e, l = g,
                            m = k(a), n = j - (l - d), o = i;
        ...
        qq.uiPublicApi = {
            ...
            _getButton: function (a) {
                ...
                function d(b) {
                    g && (f.setStatusText(a), qq(g).removeClass(h._classes.retrying), f.hideProgress(a), h.getUploads({id: a}).status !== qq.status.UPLOAD_FAILED && f.hideCancel(a), f.hideSpinner(a), b.success ? h._markFileAsSuccessful(a) : (qq(g).addClass(h._classes.fail), f.showCancel(a), f.isRetryPossible() && !h._preventRetries[a] && (qq(g).addClass(h._classes.retryable), f.showRetry(a)), h._controlFailureTextDisplay(a, b)))
                }

                var e = this._parent.prototype._onComplete.apply(this, arguments), f = this._templating,
                    g = f.getFileContainer(a), h = this;
                ...
                var b, c = this.getName(a), d = this._options.deleteFile.confirmMessage.replace(/\{filename\}/g, c),
                    e = (this.getUuid(a), arguments), f = this;
                ...
                c === qq.status.DELETED || !b && !this._options.thumbnails.placeholders.waitUntilResponse && qq.supportedFeatures.imagePreviews || this._templating.updateThumbnail(a, b, this._options.thumbnails.customResizer)
        ...
        "use strict";
        var b, c, d, e, f, g, h, i, j = "qq-file-id", k = "qq-file-id-", l = "qq-max-size", m = "qq-server-scale",
            n = "qq-hide-dropzone", o = "qq-drop-area-text", p = "qq-in-progress", q = "qq-hidden-forever",
            r = {content: document.createDocumentFragment(), map: {}}, s = !1, t = 0, u = !1, v = [], w = -1, x = {
                log: null,
                ...
                var a = x.placeholders.thumbnailNotAvailable, c = x.placeholders.waitingForThumbnail,
                    d = {maxSize: w, scale: i};
                ...
                if (e = qq.trimStr(e), g = document.createElement("div"), g.appendChild(qq.toElement(e)), t = qq(g).getFirstByClass(y.uploader), x.button && (k = qq(g).getFirstByClass(y.button), k && qq(k).remove()), qq.DragAndDrop && qq.supportedFeatures.fileDrop || (r = qq(g).getFirstByClass(y.dropProcessing), r && qq(r).remove()), p = qq(g).getFirstByClass(y.drop), p && !qq.DragAndDrop && (b("DnD module unavailable.", "info"), qq(p).remove()), qq.supportedFeatures.fileDrop ? qq(t).hasAttribute(o) && p && (s = qq(p).getFirstByClass(y.dropText), s && qq(s).remove()) : (t.removeAttribute(o), p && qq(p).hasAttribute(n) && qq(p).css({display: "none"})), q = qq(g).getFirstByClass(y.thumbnail), h ? q && (w = parseInt(q.getAttribute(l)), w = w > 0 ? w : null, i = qq(q).hasAttribute(m)) : q && qq(q).remove(), h = h && q, c = qq(g).getByClass(y.editFilenameInput).length > 0, d = qq(g).getByClass(y.retry).length > 0, f = qq(g).getFirstByClass(y.list), null == f)throw new Error("Could not find the file list container in the template!");
                ...
                var b = a.id, c = a.optFileOrBlob, d = c && c.qqThumbnailId, e = U(b),
                    f = {customResizeFunction: a.customResizeFunction, maxSize: w, orient: !0, scale: !0};
                ...
                var b = a.id, c = a.thumbnailUrl, d = a.showWaitingImg, e = U(b),
                    f = {customResizeFunction: a.customResizeFunction, scale: i, maxSize: w};
                if (e)if (c) {
                ...
                c && !qq(c).hasClass(d) && (c = qq(c).getFirstByClass(d)), c && (qq(c).css({width: b + "%"}), c.setAttribute("aria-valuenow", b))
            }, bb = function (a) {
        ...
        qq.extend(x, a), b = x.log, qq.supportedFeatures.imagePreviews || (x.limits.timeBetweenThumbs = 0, x.limits.maxThumbs = 0), f = x.containerEl, h = void 0 !== x.imageGenerator, e = Y(), C(), qq.extend(this, {
            render: function () {
                ...
                var d = I(a), e = T(d, y.dialogMessage), f = d.getElementsByTagName("INPUT")[0],
                    g = T(d, y.dialogCancelButton), h = T(d, y.dialogOkButton), i = new qq.Promise, j = function () {
        ...
        function d(b, c) {
            var d = a.paramsStore.get(b), h = "get" === a.method.toLowerCase() ? "GET" : "POST",
                i = a.endpointStore.get(b), j = f(b);
        ...
        "use strict";
        var c = this, d = b.getName, e = b.getSize, f = b.getUuid, g = b.log, h = a.forceMultipart || a.paramsInBody,
            i = function (b, c, f) {
                var g = e(b), i = d(b);
        ...
        function e(c, e, h, i, j) {
            var k, l = c.naturalWidth, m = c.naturalHeight, n = i.width, o = i.height, p = h.getContext("2d"),
                q = new qq.Promise;
            return p.save(), i.resize ? f({
                ...
                origWidth: n,
                origHeight: o
            }), k && (qq.log(qq.format("Had to reduce dimensions due to device limitations from {}w / {}h to {}w / {}h", n, o, k.newWidth, k.newHeight), "warn"), n = k.newWidth, o = k.newHeight)), g(h, n, o, i.orientation), qq.ios() ? function () {
                a(c) && (l /= 2, m /= 2);
                var d, e, f, g = 1024, h = document.createElement("canvas"), i = j ? b(c, l, m) : 1,
                    k = Math.ceil(g * n / l), q = Math.ceil(g * o / m / i), r = 0, s = 0;
                for (h.width = h.height = g, d = h.getContext("2d"); m > r;) {
                    for (e = 0, f = 0; l > e;)d.clearRect(0, 0, g, g), d.drawImage(c, -e, -r), p.drawImage(h, 0, 0, g, g, f, s, k, q), e += g, f += k;
                    r += g, s += q
                }
                p.restore(), h = d = null
        ...
        function f(a) {
            var b = a.blob, c = a.image, d = a.imageHeight, e = a.imageWidth, f = a.orientation, h = new qq.Promise,
                i = a.resize, j = document.createElement("canvas"), k = j.getContext("2d"), l = a.canvas,
                m = a.targetHeight, n = a.targetWidth;
        ...
        h.prototype.render = function (a, b) {
            b = b || {};
            var d, f = this, g = this.srcImage.naturalWidth, h = this.srcImage.naturalHeight, i = b.width, j = b.height,
                k = b.maxWidth, l = b.maxHeight, m = !this.blob || "image/jpeg" === this.blob.type,
        ...
        function k(b, c, d) {
            var e = new qq.Promise, f = new qq.Identify(b, a), g = d.maxSize, h = null == d.orient ? !0 : d.orient,
                i = function () {
        ...
        function e(a, b) {
            ...
            return qq.each(a, function (a, d) {
                if (d > 0) {
                    var e = /(max|min)(Width|Height)/.exec(a), f = e[2].charAt(0).toLowerCase() + e[2].slice(1),
                        g = b[f];
                    switch (e[1]) {
                        case"min":
                            if (d > g)return c = a, !1;
        ...
        "use strict";
        var c = a.customResizer, d = a.sendOriginal, e = a.orient, f = a.defaultType, g = a.defaultQuality / 100,
            h = a.failureText, i = a.includeExif, j = this._getSortedSizes(a.sizes);
        qq.extend(this, {
            enabled: qq.supportedFeatures.scaling && j.length > 0, getFileRecords: function (a, k, l) {
                ...
                }), n.push({uuid: a, name: k, size: o.size, blob: d ? o : null})) : n.push({
                    uuid: a,
                    name: k,
                    size: o.size,
                    blob: o
                ...
                var i = this, j = (a.qqButtonId || a.blob && a.blob.qqButtonId, []), k = null, l = h.addFileToHandler,
                    m = h.uploadData, n = h.paramsStore, o = qq.getUniqueId();
        ...
        scaleImage: function (a, b, c) {
            ...
            var d = new qq.Promise, e = c.log, f = c.getFile(a), g = c.uploadData.retrieve({id: a}), h = g && g.name,
                i = g && g.uuid, j = {
            ...
            "use strict";
            var c = a.lastIndexOf("."), d = b.type || "image/png", e = b.refType, f = "", g = qq.getExtension(a),
                h = "";
            ...
            "use strict";
            var c = this, d = a.customResizeFunction, e = a.log, f = a.maxSize, g = a.orient, h = a.type, i = a.quality,
                j = a.failedText, k = a.includeExif && "image/jpeg" === b.type && "image/jpeg" === h,
                l = new qq.Promise, m = new qq.ImageGenerator(e), n = document.createElement("canvas");
        ...
        qq.extend(h, a), h.attachTo = h.templating.getFileList(), qq.extend(this, new qq.UiEventHandler(h, b)), qq.extend(b, {
            ...
            return {
                ...
                getPolicy: function (a) {
                    var b = {}, c = [], d = a.bucket, e = a.date, f = a.clockDrift, g = a.key, h = a.accessKey,
                        i = a.acl, j = a.type, k = a.expectedStatus, l = a.sessionToken, m = a.params,
                        n = qq.s3.util.getSuccessRedirectAbsoluteUrl(a.successRedirectUrl), o = a.minFileSize,
                        p = a.maxFileSize, q = a.reducedRedundancy, r = a.region, s = a.serverSideEncryption,
                    ...
                    return b.expiration = qq.s3.util.getPolicyExpirationDate(e, f), c.push({acl: i}), c.push({bucket: d}), j && c.push({"Content-Type": j}), k && c.push({success_action_status: k.toString()}), n && c.push({success_action_redirect: n}), q && (c.push({}), c[c.length - 1][qq.s3.util.REDUCED_REDUNDANCY_PARAM_NAME] = qq.s3.util.REDUCED_REDUNDANCY_PARAM_VALUE), l && (c.push({}), c[c.length - 1][qq.s3.util.SESSION_TOKEN_PARAM_NAME] = l), s && (c.push({}), c[c.length - 1][qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_NAME] = qq.s3.util.SERVER_SIDE_ENCRYPTION_PARAM_VALUE), 2 === t ? c.push({key: g}) : 4 === t && (c.push({}), c[c.length - 1][qq.s3.util.ALGORITHM_PARAM_NAME] = qq.s3.util.V4_ALGORITHM_PARAM_VALUE, c.push({}), c[c.length - 1].key = g, c.push({}), c[c.length - 1][qq.s3.util.CREDENTIAL_PARAM_NAME] = qq.s3.util.getV4CredentialsString({
                        ...
                        var d = qq.s3.util._getPrefixedParamName(a), e = {};
                ...
                generateAwsParams: function (a, b) {
                    var c, d = {}, e = a.params, f = new qq.Promise, g = a.sessionToken, h = a.clockDrift, i = a.type,
                        j = a.key, k = a.accessKey, l = a.acl, m = a.expectedStatus,
                        n = qq.s3.util.getSuccessRedirectAbsoluteUrl(a.successRedirectUrl), o = a.reducedRedundancy,
                        p = a.region, q = a.serverSideEncryption, r = a.signatureVersion, s = new Date, t = a.log;
                ...
                parseIframeResponse: function (a) {
                    var b = a.contentDocument || a.contentWindow.document, c = b.location.search,
        ...
        qq.nonTraditionalBasePublicApi = {
            ...
            _onComplete: function (a, b, c, d) {
                var e, f, g = c.success ? !0 : !1, h = this, i = arguments, j = this._uploadSuccessEndpointStore.get(a),
                    k = this._options.uploadSuccess.customHeaders, l = this._options.uploadSuccess.method,
                    m = this._options.cors, n = new qq.Promise, o = this._uploadSuccessParamsStore.get(a),
                    p = this._paramsStore.get(a), q = function (b) {
        ...
        qq.s3.FineUploaderBasic = function (a) {
            var b = {
                request: {accessKey: null, clockDrift: 0},
                objectProperties: {
                    acl: "private", bucket: qq.bind(function (a) {
                        return qq.s3.util.getBucket(this.getEndpoint(a))
                    }, this), host: qq.bind(function (a) {
                        return /(?:http|https):\/\/(.+)(?:\/.+)?/.exec(this._endpointStore.get(a))[1]
                    }, this), key: "uuid", reducedRedundancy: !1, region: "us-east-1", serverSideEncryption: !1
                },
                credentials: {accessKey: null, secretKey: null, expiration: null, sessionToken: null},
                signature: {customHeaders: {}, endpoint: null, version: 2},
                uploadSuccess: {endpoint: null, method: "POST", params: {}, customHeaders: {}},
                iframeSupport: {localBlankPagePath: null},
            ...
            getBucket: function (a) {
                ...
                var c = this._options.objectProperties[b], d = new qq.Promise, e = this;
                ...
                var c = new qq.Promise, d = this._options.objectProperties.key, e = qq.getExtension(b), f = c.failure,
                    g = function (a, b) {
                        var d = a;
                ...
                var d = {key: this.getKey(a), uuid: this.getUuid(a), name: this.getName(a), bucket: this.getBucket(a)};
                return c && c.getResponseHeader("ETag") ? d.etag = c.getResponseHeader("ETag") : b.etag && (d.etag = b.etag), d
            }, _onSubmitDelete: function (a, b) {
                var c = {key: this.getKey(a), bucket: this.getBucket(a)};
    ...
    }(), window.Uint8ClampedArray || (window.Uint8ClampedArray = function () {
    }), qq.s3.RequestSigner = function (a) {
        "use strict";
        function b(a, b, c) {
            var d, e, f = b.responseText, g = j[a], h = g.promise, i = g.signatureConstructor;
            if (delete j[a], f)try {
                e = qq.parseJson(f)
            } catch (m) {
        ...
        function c(a, b, c) {
            var d, e, f, g = new qq.Promise, h = "POST", j = [], l = "", o = new Date, p = function (a) {
                var c, g = [];
        ...
        var g, h, i = this, j = {}, k = {
            expectingPolicy: !1,
            method: "POST",
            signatureSpec: {drift: 0, credentialsProvider: {}, endpoint: null, customHeaders: {}, version: 2},
            maxConnections: 3,
            endpointStore: {},
            paramsStore: {},
            cors: {expected: !1, sendCredentials: !1},
            ...
            getStringToSign: function (a) {
                ...
                var d = qq.CryptoJS.enc.Utf8.parse(b), e = qq.CryptoJS.HmacSHA1(d, h.get().secretKey),
                    f = qq.CryptoJS.enc.Base64.stringify(e);
                l(a, f, c)
            }, signPolicy: function (a, b, c, d) {
                var e = JSON.stringify(a), f = qq.CryptoJS.enc.Utf8.parse(e), g = qq.CryptoJS.enc.Base64.stringify(f),
                    i = qq.CryptoJS.HmacSHA1(g, h.get().secretKey), j = qq.CryptoJS.enc.Base64.stringify(i);
                b.success({policy: g, signature: j}, c, d)
            }
        }, n = {
            getCanonicalQueryString: function (a) {
                var b, c, d, e = a.indexOf("?"), f = "";
                ...
                return qq.isBlob(a) ? (b = new FileReader, b.onloadend = function (a) {
                    if (a.target.readyState === FileReader.DONE)if (a.target.error) c.failure(a.target.error); else {
                        var b = qq.CryptoJS.lib.WordArray.create(a.target.result);
                        c.success(qq.CryptoJS.SHA256(b).toString())
                    }
                }, b.readAsArrayBuffer(a)) : (a = a || "", c.success(qq.CryptoJS.SHA256(a).toString())), c
            }, getScope: function (a, b) {
                return qq.s3.util.getCredentialsDate(a) + "/" + b + "/s3/aws4_request"
            }, getStringToSign: function (a) {
                var b = n.getCanonicalRequest(a), c = qq.s3.util.getV4PolicyDate(a.date, a.drift),
                    d = qq.CryptoJS.SHA256(b).toString(), e = n.getScope(a.date, k.signatureSpec.region),
                    f = "AWS4-HMAC-SHA256\n{}\n{}\n{}";
                return {hashed: qq.format(f, c, e, d), raw: qq.format(f, c, e, b)}
                ...
                var d, e, f, g, i = h.get().secretKey, j = /.+\n.+\n(\d+)\/(.+)\/s3\/.+\n(.+)/, k = j.exec(b);
                d = qq.CryptoJS.HmacSHA256(k[1], "AWS4" + i), e = qq.CryptoJS.HmacSHA256(k[2], d), f = qq.CryptoJS.HmacSHA256("s3", e), g = qq.CryptoJS.HmacSHA256("aws4_request", f), l(a, qq.CryptoJS.HmacSHA256(b, g), c)
            }, signPolicy: function (a, b, c, d) {
                var e, f, g, i, j, k = JSON.stringify(a), l = qq.CryptoJS.enc.Utf8.parse(k),
                    m = qq.CryptoJS.enc.Base64.stringify(l), n = h.get().secretKey,
                    o = /.+\/(.+)\/(.+)\/s3\/aws4_request/, p = function () {
                        var b = null;
                ...
                e = o.exec(p), f = qq.CryptoJS.HmacSHA256(e[1], "AWS4" + n), g = qq.CryptoJS.HmacSHA256(e[2], f), i = qq.CryptoJS.HmacSHA256("s3", g), j = qq.CryptoJS.HmacSHA256("aws4_request", i), b.success({
                    policy: m,
                    signature: qq.CryptoJS.HmacSHA256(m, j).toString()
                }, c, d)
            }
        };
        qq.extend(k, a, !0), h = k.signatureSpec.credentialsProvider, g = qq.extend(this, new qq.AjaxRequester({
            ...
            getSignature: function (a, b) {
                var c, e = b, f = b.signatureConstructor, i = new qq.Promise;
                return 4 === k.signatureSpec.version && (c = {v4: !0}), h.get().secretKey && qq.CryptoJS ? h.get().expiration.getTime() > Date.now() ? d(a, b, i) : h.onExpired().then(function () {
                    ...
                    e = {headers: b.stringToSignRaw}, g.initTransport(a).withParams(e).withQueryParams(c).send()
                ...
                return {
                    withHeaders: function (a) {
                        ...
                        var o = h.get().sessionToken, p = new qq.Promise,
        ...
        "use strict";
        function b(a) {
            var b, c = g.getBucket(a), d = g.getHost(a), f = {}, h = new qq.Promise, i = g.getKey(a);
            ...
            }), b = e.constructStringToSign(e.REQUEST_TYPE.MULTIPART_INITIATE, c, d, i).withContentType(g.getContentType(a)).withHeaders(f), e.getSignature(a, {signatureConstructor: b}).then(h.success, h.failure), h
        }
        ...
        qq.extend(g, a), e = new qq.s3.RequestSigner({
            ...
            log: g.log,
            onComplete: c,
            successfulResponseCodes: {POST: [200]}
        })), qq.extend(this, {
            send: function (a) {
                var c = new qq.Promise;
        ...
        "use strict";
        function b(a, b, c) {
            var d = new qq.Promise, e = h.getBucket(a), g = h.getHost(a),
            ...
            return f.getSignature(a, {signatureConstructor: i}).then(d.success, d.failure), d
        }

        function c(a, b, c) {
            var d = g[a], e = new DOMParser, f = h.getBucket(a),
                i = (h.getKey(a), e.parseFromString(b.responseText, "application/xml")),
                j = i.getElementsByTagName("Bucket"), k = i.getElementsByTagName("Key");
        ...
        function d(a) {
            ...
            return a.sort(function (a, b) {
                ...
                var d = c.part, e = c.etag, f = b.createElement("Part"), g = b.createElement("PartNumber"),
                    h = b.createTextNode(d), i = b.createTextNode(e), j = b.createElement("ETag");
        ...
        "use strict";
        function b(a, b) {
            var c = new qq.Promise, d = f.getBucket(a), g = f.getHost(a),
                h = e.constructStringToSign(e.REQUEST_TYPE.MULTIPART_ABORT, d, g, f.getKey(a)).withUploadId(b);
            return e.getSignature(a, {signatureConstructor: h}).then(c.success, c.failure), c
        }

        function c(a, b, c) {
            var d, e = new DOMParser, g = e.parseFromString(b.responseText, "application/xml"),
        ...
        var d, e, f = {
            method: "DELETE", endpointStore: null, signatureSpec: null, maxConnections: 3, getBucket: function () {
            }, getHost: function () {
            }, getKey: function () {
            }, log: function () {
            }
        ...
        qq.extend(f, a), e = new qq.s3.RequestSigner({
            ...
            log: f.log,
            onComplete: c,
            successfulResponseCodes: {DELETE: [204]}
        })), qq.extend(this, {
            send: function (a, c) {
        ...
        "use strict";
        var c = b.getName, d = b.log, e = a.clockDrift, f = 200, g = a.getBucket, h = a.getHost, i = a.getKeyName,
            j = a.filenameParam, k = a.paramsStore, l = a.endpointStore, m = a.aclStore,
            n = a.objectProperties.reducedRedundancy, o = a.objectProperties.region,
            p = a.objectProperties.serverSideEncryption, q = a.validation,
            r = qq.extend({region: o, drift: e}, a.signature), s = this, t = a.signature.credentialsProvider, u = {
                combine: function (a) {
                    var b = s._getPersistableData(a).uploadId, c = s._getPersistableData(a).etags, d = new qq.Promise;
                    ...
                    var d = x.bucket.getName(a), e = x.host.getName(a), f = x.key.urlSafe(a), g = new qq.Promise,
                    ...
                    return v.restSignature.getSignature(a + "." + b, {signatureConstructor: h}).then(g.success, g.failure), g
                }, put: function (b, c) {
                    var e = s._createXhr(b, c), f = s._getChunkData(b, c), g = a.endpointStore.get(b), h = new qq.Promise;
                    return u.initHeaders(b, c, f.blob).then(function (a, i) {
                        if (e._cancelled) d(qq.format("Upload of item {}.{} cancelled. Upload will not start after successful signature request.", b, c)), h.failure({error: "Chunk upload cancelled"}); else {
                            var j = g + "/" + i;
                            s._registerProgressHandler(b, c, f.size), x.track(b, e, c).then(h.success, h.failure), e.open("PUT", j, !0), qq.each(a, function (a, b) {
                                e.setRequestHeader(a, b)
                            }), e.send(f.blob)
                        }
                    }, function () {
                        h.failure({error: "Problem signing the chunk!"}, e)
                    }), h
                }, send: function (a, b) {
                    var c = new qq.Promise;
                    ...
                    var b = new qq.Promise, c = s._getPersistableData(a).uploadId, d = new qq.Promise;
                    return c ? c instanceof qq.Promise ? c.then(function (a) {
                        ...
                        s._getPersistableData(a).uploadId = null, b.failure(c, e), d.failure(c, e)
                    })), b
                }
            }, v = {
                ...
                policySignature: new qq.s3.RequestSigner({expectingPolicy: !0, signatureSpec: r, cors: a.cors, log: d}),
                restSignature: new qq.s3.RequestSigner({endpointStore: l, signatureSpec: r, cors: a.cors, log: d})
            }, w = {
                initParams: function (a) {
                    ...
                    var b = new qq.Promise, c = s._createXhr(a), e = s.getFile(a);
                    ...
                    var d = new FormData, e = l.get(a), f = e, g = new qq.Promise;
                ...
                bucket: {
                    promise: function (a) {
                        var b = new qq.Promise, c = s._getFileState(a).bucket;
                    ...
                    promise: function (a) {
                        var b = new qq.Promise, c = s._getFileState(a).host;
                    ...
                    var c = x.response.parse(a, b), e = c.success !== !0;
                    ...
                    promise: function (a) {
                        var b = new qq.Promise, d = s.getThirdPartyFileId(a);
                    ...
                    parse: function (a, b) {
                        ...
                        var b, c, d = new DOMParser, e = d.parseFromString(a, "application/xml"),
                            f = e.getElementsByTagName("Error"), g = {};
        ...
        qq.extend(this, {
            ...
            options: qq.extend({namespace: "s3"}, a),
            proxy: qq.extend({getEndpoint: a.endpointStore.get}, b)
            ...
            return {
                expunge: function (b) {
                    ...
                    var c = a._getLocalStorageId(b), d = x.bucket.getName(b);
                    return c + "-" + d
                }
            }
        })
        ...
        "use strict";
        function c(b, c) {
            var d, e, f, g = (a.endpointStore.get(b), h._getFileState(b).bucket);
            try {
                if (d = c.contentDocument || c.contentWindow.document, e = d.body.innerHTML, f = qq.s3.util.parseIframeResponse(c), f.bucket === g && f.key === qq.s3.util.encodeQueryStringParam(h.getThirdPartyFileId(b)))return !0;
        ...
        var h = this, i = a.clockDrift, j = b.onUuidChanged, k = b.getName, l = b.getUuid, m = b.log, n = a.getBucket,
            o = a.getKeyName, p = a.filenameParam, q = a.paramsStore, r = a.endpointStore, s = a.aclStore,
            t = a.objectProperties.reducedRedundancy, u = a.objectProperties.region,
            v = a.objectProperties.serverSideEncryption, w = a.validation, x = a.signature,
            y = a.iframeSupport.localBlankPagePath, z = a.signature.credentialsProvider,
            A = new qq.s3.RequestSigner({signatureSpec: x, cors: a.cors, log: m});
        ...
        qq.extend(this, new qq.FormUploadHandler({
            options: {isCors: !1, inputName: "file"},
            proxy: {onCancel: a.onCancel, onUuidChanged: j, getName: k, getUuid: l, log: m}
        })), qq.extend(this, {
            uploadFile: function (a) {
                var b = k(a), c = new qq.Promise;
        ...
        qq.s3.FineUploader = function (a) {
            ...
            "use strict";
            return {
                AZURE_PARAM_PREFIX: "x-ms-meta-", _paramNameMatchesAzureParameter: function (a) {
                    switch (a) {
                        case"Cache-Control":
                    ...
                    var b = {};
                    return qq.each(a, function (a, c) {
                        var d = qq.azure.util._getPrefixedParamName(a), e = null;
                    ...
                    var c, d, e = new DOMParser, f = e.parseFromString(a, "application/xml"),
        ...
        qq.azure.FineUploaderBasic = function (a) {
            ...
            var b = {
                signature: {endpoint: null, customHeaders: {}},
                blobProperties: {name: "uuid"},
                uploadSuccess: {endpoint: null, method: "POST", params: {}, customHeaders: {}},
                chunking: {partSize: 4e6, minFileSize: 4000001}
            };
            ...
            getBlobName: function (a) {
                ...
                var b = this._options.blobProperties.name, c = this.getUuid(a), d = this.getName(a),
                    e = qq.getExtension(d), f = c;
                ...
                var c = this, d = {}, e = {
                    ...
                    endpointStore: f, log: qq.bind(c.log, c), onDelete: function (a) {
                    ...
                    cors: this._options.cors, endpointStore: {
                        get: function () {
        ...
        var g = this, h = b.log, i = a.cors, j = a.endpointStore, k = a.paramsStore, l = a.signature,
            m = a.filenameParam, n = a.chunking.minFileSize, o = a.deleteBlob, p = a.onGetBlobName, q = b.getName,
            r = b.getSize, s = function (a) {
                var b = k.get(a);
                return b[m] = q(a), b
            }, t = {
                putBlob: new qq.azure.PutBlob({getBlobMetadata: s, log: h}),
                putBlock: new qq.azure.PutBlock({log: h}),
                putBlockList: new qq.azure.PutBlockList({getBlobMetadata: s, log: h}),
        ...
        qq.extend(this, {
            ...
            options: qq.extend({namespace: "azure"}, a),
            proxy: qq.extend({getEndpoint: a.endpointStore.get}, b)
        })), qq.override(this, function (a) {
            return {
                expunge: function (b) {
        ...
        qq.extend(d, a), c = qq.extend(this, new qq.AjaxRequester({
            ...
            validMethods: ["GET"],
            method: "GET",
            successfulResponseCodes: {GET: [200]},
            contentType: null,
            customHeaders: d.customHeaders,
            endpointStore: d.endpointStore,
            cors: d.cors,
        ...
        "use strict";
        var b, c = "DELETE", d = {
            endpointStore: {}, onDelete: function () {
            }, onDeleteComplete: function () {
            }, log: function () {
            }
        };
        ...
        qq.extend(d, a), b = qq.extend(this, new qq.AjaxRequester({
            ...
            method: c, upload: function (a, c, g, h) {
        ...
        qq.extend(f, a), c = qq.extend(this, new qq.AjaxRequester({
            ...
            method: d, send: function (a, d, h, i, j) {
        ...
        qq.extend(g, a), c = qq.extend(this, new qq.AjaxRequester({
            ...
            method: d, upload: function (a, d, i, j, k) {
        ...
        var a = qq.CryptoJS, b = a.lib, c = b.WordArray, d = a.enc;
        d.Base64 = {
            stringify: function (a) {
        ...
        var a = qq.CryptoJS, b = a.lib, c = b.Base, d = a.enc, e = d.Utf8, f = a.algo;
        f.HMAC = c.extend({
            init: function (a, b) {
        ...
        var a = qq.CryptoJS, b = a.lib, c = b.WordArray, d = b.Hasher, e = a.algo, f = [], g = e.SHA1 = d.extend({
            _doReset: function () {
        ...
        var b = qq.CryptoJS, c = b.lib, d = c.WordArray, e = c.Hasher, f = b.algo, g = [], h = [];
        !function () {
            function b(b) {
                for (var c = a.sqrt(b), d = 2; c >= d; d++)if (!(b % d))return !1;
                return !0
            }
        ...
        if ("function" == typeof ArrayBuffer) {
            var a = qq.CryptoJS, b = a.lib, c = b.WordArray, d = c.init, e = c.init = function (a) {
