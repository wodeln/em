...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?document-master-files-courseEdit" method="post" class="form-horizontal">
						<div class="form-group">
				            <label for="coursetitle" class="control-label col-sm-2">课件名称：</label>
				            <div class="col-sm-9">
							    <input class="form-control" type="text" id="coursetitle" name="args[course_name]" value="{x2;$course[course_name]}" needle="needle" msg="您必须输入课件名称">
					        </div>
				        </div>
						...
						<div class="form-group">
									...
									<div class="qq-uploader-selector" qq-drop-area-text="可将图片拖拽至此处上传" style="clear:both;">
										<ul class="qq-upload-list-selector list-unstyled pull-left" aria-live="polite" aria-relevant="additions removals">
											<li class="text-center">
												<input size="33" readonly class="form-control qq-edit-filename-selector" type="text" name="args[ppt_name]" tabindex="0" value="{x2;$course[ppt_name]}">
											</li>
										</ul>
										<ul class="qq-upload-list-selector list-unstyled pull-left" aria-live="polite" aria-relevant="additions removals">
											<li class="text-center">
							...
							<input type="hidden" id="sound_file" name="args[course_file]" value="{x2;$course[course_file]}">
						</div>

						<div class="form-group">
							<label for="basic" class="control-label col-sm-2">备注：</label>
							<div class="col-sm-9">
								<textarea class="form-control" rows="4" name="args[memo]" id="memo" autocomplete="off">{x2;$course[memo]}</textarea>
							</div>
						</div>
				        <div class="form-group">
				            ...
				            <div class="col-sm-9">
					            ...
					            <input type="hidden" name="modifyCourse" value="1">
					            <input type="hidden" name="custom_course_id" value="{x2;$course[custom_course_id]}">
					        </div>
				        </div>
					</form>
				</div>
