	...
	<div class="row-fluid">
		<div class="main">
			<div class="col-xs-3" style="width: 300px;">
				<h1 style="font-size:30px;color:#337AB7;"><img src="app/core/styles/img/logo2.png" style="height:35px;margin-top:-10px;"/>&nbsp;<b>嘉奕医学</b></h1>
			</div>
			<div class="col-xs-1">
			</div>
			...
			<div class="col-xs-2" style="padding-top:22px;">
				<ul class="list-unstyled list-inline">
					...
					{x2;else}
					<li><a href="index.php?user-app-login" class="btn btn-default"> 登 录 </a></li>
		...
		<div class="main">
			<div class="col-xs-12">
				<ul class="list-unstyled list-inline">
					...
					<li class="menu col-xs-1"><a href="index.php?exam-teach-users">考试</a></li>
                    {x2;else}
